...
import { InfoIcon, LikeIcon, ReplyIcon, ReTweetIcon, ShareIcon, VerifiedIcon } from '../../../icons/icon'

const Tweet = ({ displayName, username, verified, text, image, avatar, reply, retweet, like, share }) => {
